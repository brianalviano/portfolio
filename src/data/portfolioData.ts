...
export const portfolioData = {
  ...
  about: {
    ...
    stats: [
      { count: 23, label: { en: 'Completed projects', id: 'Proyek selesai' }, accent: true },
    ...
    contactQuickList: [
      { label: { en: 'Location', id: 'Lokasi' }, value: 'Surabaya, East Java, Indonesia' },
      { label: { en: 'Phone / WA', id: 'Telepon / WA' }, value: '+62 813-7000-4025', href: 'tel:+6281370004025' },
      { label: { en: 'Email', id: 'Email' }, value: 'brianalviano.official@gmail.com', href: 'mailto:brianalviano.official@gmail.com' }
    ],
    connectOnline: {
      en: 'Connect Online',
      id: 'Terhubung Online'
  ...
  projects: {
    ...
    items: [
      {
        id: 'daki-pet-shop',
        category: { en: 'ERP CASE STUDY · Retail · Multi-branch', id: 'STUDI KASUS ERP · Retail · Multi-cabang' },
        title: 'DAKI Pet Shop',
        subtitle: { en: 'Custom retail operations platform', id: 'Platform operasional retail kustom' },
        brief: {
        ...
        meta: [
          { label: { en: 'Role', id: 'Peran' }, value: { en: 'Full-stack lead', id: 'Full-stack lead' } },
          { label: { en: 'Focus', id: 'Fokus' }, value: { en: 'Operational visibility', id: 'Visibilitas operasional' } },
          { label: { en: 'Format', id: 'Format' }, value: { en: 'Product system', id: 'Sistem produk' } }
        ],
        handles: [
          { en: 'Branch inventory, stock movement, returns, and stock-opname workflows.', id: 'Manajemen stok cabang, mutasi barang, retur, dan proses opname.' },
          { en: 'Purchase requests, supplier orders, receiving, and purchase history.', id: 'Permintaan pembelian, order supplier, penerimaan barang, dan riwayat PO.' },
          { en: 'Sales reporting with branch-level visibility and role-based access.', id: 'Laporan penjualan dengan visibilitas antar-cabang dan hak akses pengguna.' }
        ],
        stack: ['Laravel', 'Svelte', 'Tailwind CSS', 'PostgreSQL', 'Redis', 'REST API', 'Docker', 'Nginx']
      },
      {
        id: 'simetik',
        category: { en: 'RESEARCH SYSTEM · University · Workflow', id: 'SISTEM PENELITIAN · Universitas · Alur Kerja' },
        title: 'SIMETIK',
        subtitle: { en: 'Medical research management portal', id: 'Portal manajemen etik penelitian medis' },
        brief: {
        ...
        meta: [
          { label: { en: 'Role', id: 'Peran' }, value: { en: 'Full-stack developer', id: 'Full-stack developer' } },
          { label: { en: 'Focus', id: 'Fokus' }, value: { en: 'Workflow digitization', id: 'Digitalisasi alur kerja' } },
          { label: { en: 'Format', id: 'Format' }, value: { en: 'Product system', id: 'Sistem produk' } }
        ],
        handles: [
          { en: 'Structured submissions for human, animal, and non-clinical studies.', id: 'Pengajuan terstruktur untuk studi manusia, hewan, dan non-klinis.' },
          { en: 'Role-based review, revision history, and document validation.', id: 'Penilaian berbasis peran, riwayat revisi, dan validasi dokumen.' },
          { en: 'Payment tracking, meeting schedules, progress status, and reporting.', id: 'Pelacakan pembayaran, jadwal sidang, status progres, dan pelaporan.' }
        ],
        stack: ['PHP', 'Laravel', 'MySQL', 'JavaScript', 'REST API', 'Role access', 'Nginx']
      },
      {
        id: 'pelangi-uv',
        category: { en: 'CORPORATE WEBSITE', id: 'WEBSITE PERUSAHAAN' },
        title: 'Pelangi UV',
        subtitle: { en: 'Printing-finishing company site', id: 'Website perusahaan cetak & finishing' },
        brief: {
        ...
        meta: [
          { label: { en: 'Role', id: 'Peran' }, value: { en: 'Full-stack developer', id: 'Full-stack developer' } },
          { label: { en: 'Focus', id: 'Fokus' }, value: { en: 'Corporate web presence', id: 'Profil web perusahaan' } },
          { label: { en: 'Format', id: 'Format' }, value: { en: 'Company profile', id: 'Profil perusahaan' } }
        ],
        handles: [
          { en: 'Full service catalog and printing-finishing capabilities showcase.', id: 'Katalog layanan lengkap dan keunggulan mesin finishing cetak.' },
          { en: 'High-converting inquiry & quote request contact flows.', id: 'Formulir kontak & permintaan penawaran harga yang efektif.' },
          { en: 'Search engine optimization (SEO) and fast page load performance.', id: 'Optimasi mesin pencari (SEO) dan kecepatan muat halaman.' }
        ],
        stack: ['Laravel', 'Tailwind CSS', 'JavaScript', 'SEO', 'Responsive UI']
      },
      {
        id: 'maha-koding',
        category: { en: 'AGENCY WEBSITE', id: 'WEBSITE AGENSI' },
        title: 'Maha Koding',
        subtitle: { en: 'Software agency landing portal', id: 'Portal landing page agensi software' },
        brief: {
        ...
        meta: [
          { label: { en: 'Role', id: 'Peran' }, value: { en: 'Full-stack developer', id: 'Full-stack developer' } },
          { label: { en: 'Focus', id: 'Fokus' }, value: { en: 'Lead conversion', id: 'Konversi prospek' } },
          { label: { en: 'Format', id: 'Format' }, value: { en: 'Landing page', id: 'Landing page' } }
        ],
        handles: [
          { en: 'Transparent service package pricing calculator & tier comparison.', id: 'Kalkulator paket layanan & perbandingan tingkat harga.' },
          { en: 'Interactive FAQ accordion and client testimonial showcase.', id: 'Accordion FAQ interaktif dan tampilan testimoni klien.' },
          { en: 'Lead conversion funnel directly connected to WhatsApp inquiry.', id: 'Alur konversi prospek yang terhubung langsung ke WhatsApp.' }
        ],
  ...
  testimonials: {
    ...
    list: [
      ...
      },
      {
        ...
        role: { en: 'Academic & Medical Research', id: 'Akademik & Penelitian Medis' },
        accentBg: 'bg-[#dce7f4]'
      },
      {
        quote: {
  ...
  clients: {
    ...
    items: [
      { name: 'Pelangi UV', industry: { en: 'Printing & Manufacturing', id: 'Percetakan & Manufaktur' }, icon: 'ti-printer', bg: 'bg-[#f4d9d0]' },
      { name: 'Awniraya', industry: { en: 'Logistics & Freight', id: 'Logistik & Ekspedisi' }, icon: 'ti-truck-delivery', bg: 'bg-[#dce7f4]' },
      { name: 'DAKI Pet Shop', industry: { en: 'Multi-branch Retail', id: 'Retail Multi-Cabang' }, icon: 'ti-paw', bg: 'bg-[#f5e0a9]' },
      { name: 'Universitas Airlangga', industry: { en: 'Education & Research', id: 'Pendidikan & Penelitian' }, icon: 'ti-school', bg: 'bg-[#dcebdc]' },
      { name: 'GAPALA', industry: { en: 'Financial Operations', id: 'Operasional Keuangan' }, icon: 'ti-building-bank', bg: 'bg-[#eadcf1]' },
      { name: 'Burningroom', industry: { en: 'Technology Partner', id: 'Mitra Teknologi' }, icon: 'ti-code', bg: 'bg-ink text-white' }
    ]
  },
  ...
  cta: {
    ...
    asidePoints: [
      { num: '01', text: { en: 'Business problem or product goal', id: 'Masalah bisnis atau target produk' } },
      { num: '02', text: { en: 'Users and current workflow', id: 'Pengguna dan alur kerja saat ini' } },
      { num: '03', text: { en: 'Timeline and existing tech stack', id: 'Target waktu dan tech stack yang ada' } }
    ],
    preferDirect: {
    ...
    labels: {
      ...
      message: { en: 'Tell me about the project', id: 'Ceritakan tentang proyek ini' },
      messagePlaceholder: {
